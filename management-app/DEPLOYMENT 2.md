# Deployment Guide for WineME Management App
...
2. **Deploy from the management-app folder**:
   ```bash
   cd management-app
   vercel
   ```
...
4. **Your app will be live at**: `https://your-management-app-name.vercel.app`
...
4. The app will be available at: `https://yourusername.github.io/management-app`
...
- The management app requires authentication - make sure you have created manager accounts
- Keep the deployment URL secure as this is an admin/management interface
